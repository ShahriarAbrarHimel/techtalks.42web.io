<div class="body">
	...
	<form method="post" action="">
		...
		<div class="input-group">
			...
			<input class="half" type="text" name="title_np" placeholder="Post Title in Bangla">
		</div>
		<div class="input-group">
		...
		<div class="input-group">
			...
			<textarea class="half" name="description_np" placeholder="Post Description in Bangla" required="true"></textarea>
		</div>
		<div class="input-group">
